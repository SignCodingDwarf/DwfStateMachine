 ...
 * Id class should contain operator==.
 *
 */

/*
Copyright (c) 2020 SignC0dingDw@rf. All rights reserved
...
{
    template<class T>
    IdentifiedElement<T>::IdentifiedElement(T id) : m_id(id)
    {
    }
    ...
    template<class T>
    T IdentifiedElement<T>::getId() const
    {
        return m_id;
    }
}
